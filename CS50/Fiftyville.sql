...
-- Query 1: Getting the description of the theft:
...
-- Query 2: Getting the interviews
...
-- Start by finding the id of the Fiftyville airport and the join it with the flights table
